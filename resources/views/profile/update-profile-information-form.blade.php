    ...
    <x-slot name="form">
        ...
        @foreach($roles as $role)
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-input id="description" type="text" class="mt-1 block w-full" wire:model="state.description" autocomplete="description" />
                <x-input-error for="description" class="mt-2" />
            </div>

            <div class="col-span-6 sm:col-span-4">
                <x-label for="category" value="{{ __('Prestations de service') }}" />
                <select id="category" name="category" class="form-control" wire:model.defer="state.category_id">
