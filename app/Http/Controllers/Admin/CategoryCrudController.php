...
class CategoryCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix', 'admin').'/service_type');
        ...
        CRUD::addColumn([   // select_multiple: n-n relationship (with pivot table)
            ...
            'wrapper' => [
                'href' => function ($crud, $column, $entry, $related_key) {
                    return backpack_url('service?category_id='.$entry->getKey());
                },
            ],
        ]);
    }
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::addField([
            ...
            'label' => 'Slug (URL)',
            'type' => 'text',
            'hint' => 'Will be automatically generated from name.',
            'attributes' => [
                'id' => 'generateslug',
            ],
            // 'disabled' => 'disabled'
