...
class ArticleCrudController extends CrudController
{
            ...
            $this->crud->addColumn([
                ...
                'wrapper' => [
                    'href' => function ($crud, $column, $entry, $related_key) {
                        return backpack_url('service_type/'.$related_key.'/show');
                    },
                ],
            ]);
    ...
    {    
        ...
        if ($querystring) {
            $categoriesQuery->where('name', 'like', '%' . $querystring . '%');
        }
    ...
    public function fetchTags()
    {
        ...
        if ($querystring) {
            $tagsQuery->where('name', 'like', '%' . $querystring . '%');
        }
